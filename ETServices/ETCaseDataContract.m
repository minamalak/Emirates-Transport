...
@implementation ETCaseDataContract
@synthesize Area;
...
- (id)initWithData: (NSDictionary *)dictionary {
	if(self = [super init]) {
		...
		self.ComplaintDateTime = [WebServiceEntities deserializeJsonDateString:[dictionary objectForKey: @"ComplaintDateTime"]];
		...
		NSObject *SatisfactionRef = [dictionary objectForKey:@"Satisfaction"];
		if([SatisfactionRef isKindOfClass:[NSNull class]]) {
			self.Satisfaction = nil;
		}
		else {
			self.Satisfaction = [[ETIntLookupItem alloc] initWithData:[dictionary objectForKey: @"Satisfaction"]];
		}
...
- (NSDictionary *)JSONDictionary {
	...
	[dictionary setValue:[WebServiceEntities serializeToJsonDateString: self.ComplaintDateTime] forKey:@"ComplaintDateTime"];
	...
	[dictionary setValue:[self.Satisfaction JSONDictionary] forKey:@"Satisfaction"];
